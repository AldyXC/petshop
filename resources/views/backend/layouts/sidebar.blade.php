<div>
    <span class="text-white absolute text-4xl mx-4 my-4 cursor-pointer block lg:hidden" id="toggle-btn">
        <i class="bi bi-filter-left px-2 bg-gray-900 rounded-md"></i>
    </span>
    <div id="dashsidebar" class="sidebar h-screen lg:block hidden p-2 w-[300px] overflow-y-auto text-center bg-gray-900">
        ...
        <div
            ...
            <span class="text-[15px] ml-4 text-gray-200">Buyout Reports</span>
        </div>
        <hr class="my-4 text-gray-600" />
        <div
            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
            <i class="bi bi-people-fill"></i>
            <span class="text-[15px] ml-4 text-gray-200">All Users</span>
        </div>
        <div
            class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
